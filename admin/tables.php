...
<form action="addtable.php" method="post">
  <div class="container1" style="width:700px;height:120px;border:2px solid black;margin-left:25%;">
    <div style="color:red;text-align:center;"><h1>Add Table</h1>
    </div>

    <label for="tname"><b>Table Name</b></label>
                        ...
                        <?php 
                            ...
                            <tr>
                              ...
                              <td>
								 ...
								 <a  href="tableoption.php?tnav=<?php echo $row['tid']; ?>" ><button class="btn btn-sm btn-danger">Not Available</button></a>
                                <a  href="tableoption.php?tav=<?php echo $row['tid']; ?>" ><button class="btn btn-sm btn-primary">Available</button></a> 
								<a  href="tableoption.php?tid=<?php echo $row['tid']; ?>" ><button class="btn btn-sm btn-danger">Delete</button></a> 
